...
public class FutureBlock {
    ...
    public void place() {
        BukkitCommon.getInstance().getBlockManager().setBlockFast(this.location.getWorld(), (int)this.location.getX(), (int)this.location.getY(), (int)this.location.getZ(), this.type.getId(), this.data);
    }
