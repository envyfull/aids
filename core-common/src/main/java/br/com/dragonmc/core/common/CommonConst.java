...
public class CommonConst {
    ...
    public static final Gson GSON = new GsonBuilder().excludeFieldsWithModifiers(new int[]{128, 8, 4}).create();
    public static final Gson GSON_PRETTY = new GsonBuilder().excludeFieldsWithModifiers(new int[]{128, 8, 4}).setPrettyPrinting().create();
    ...
    public static final String PRINCIPAL_DIRECTORY = LINUX ? "/root/" : "C:\\Users\\ALLAN\\Desktop\\high\\Server";
    ...
    public static final String BUNGEECORD_SERVERID = "bungeecord.dragonmc.com.br";
    public static final String DISCORD_SERVERID = "discord.dragonmc.com.br";
