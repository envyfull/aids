...
public class CodeCreator {
    ...
    public String random(int characters) {
        ...
        if (this.upperCase) {
            avaiableCharacters = avaiableCharacters + LETTERS.toUpperCase();
        }
        if (this.numbers) {
            avaiableCharacters = avaiableCharacters + NUMBERS;
        }
        if (this.specialCharacters) {
            avaiableCharacters = avaiableCharacters + SPECIAL_CHARACTERS;
        }
